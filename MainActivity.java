...
public class MainActivity extends AppCompatActivity {
    ...
    // Helpful Constants
    // in order to Play sound, the below variables have to be initialized
    ...
    private SoundPool mSoundPool; //added
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // SoundPool (int maximumStreaming, int streamtype, int srcQuality [0 is default])
